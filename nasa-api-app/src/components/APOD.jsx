        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-800 text-white"
            />
          </div>
          {apodData ? (
            <div className="flex flex-col-reverse overflow-hidden bg-gray-800 rounded-lg shadow-md lg:flex-row">
